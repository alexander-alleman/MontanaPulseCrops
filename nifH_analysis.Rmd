...
####Check for significance in the other meterics to for irrgation (Dryland vs irrigated)
...
####Will remove Site catagories like elevation, lat, long etc that do not diffrentate between site we can call these all geographical factors as they do not change between sites. 
```{r}
...
```
####Only site appears in the complete RDA model. This is a liner based method and might not work well with out data. 
